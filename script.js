const apiKey = '49a0ff6ef34c2d3a8ee39be9bd3d540d';
...
// Mapping of weather background images to weather condition codes (Depending on Openweather Api Response)
...
function fetchWeatherData(location) {
  ...
  fetch(apiUrl)
    ...
    .then((data) => {
      ...
      leftInfo.style.backgroundImage = `url(./images/${weatherBackgroundMap[todayWeatherIconCode]})`;
